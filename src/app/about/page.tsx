      ...
      >
        ...
        >
          ...
          <div className="flex-1 text-black leading-relaxed space-y-6">
            <p>
              Anatomy gives your agent a body. A place to put its parts.
            </p>
            <p>
              When you build an agent, it needs identity, memory, tools, references.
              These pieces often live scattered across prompts and configs.
              Anatomy makes them visible, tangible, rearrangeable.
            </p>
            <p>
              Your agent connects and receives a link. You drag artifacts around a lobster.
              You edit what each part contains. When ready, your agent pulls the updated config and becomes.
            </p>
            <p>
              Built by <a href="https://appstar.tv" target="_blank" rel="noopener noreferrer" className="underline">Appstar</a>.
            </p>
          </div>
